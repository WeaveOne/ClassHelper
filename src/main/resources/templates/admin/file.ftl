	...
	<div id="sidebar-nav">
		<ul id="dashboard-menu">
			...
			<li ><a class="dropdown-toggle" href="#"> <i
				...
				<li>
                <a class="active" href="/admin/file/1">
            ...
            <div id="pad-wrapper" class="users-list">
                    ...
                    <table class="table table-hover">
                       ...
                       <#if data?? && (data?size > 0) > 
			             <#list data as d>
			             	 <tr class="first">
                            <td>
                                <a href="/app/downloadFile/${d.tId}/${d.fileName}">${d.realName}</a>
                            </td>
                            <td>
                               ${d.tId}
                            </td>
                             <td>
                                <a href="/admin/deleteFile?id=${d.fileName}">delete</a>
                            </td>
                        </tr>
			              </#list>
			            </#if>
                ...
                <div class="pagination pull-right">
                    <ul>
                        ...
                        <#else>
                        	 <li><a href="/admin/file/${cnt.page-1}">&#8249;</a></li>
                         </#if>
			            <#list 1..cnt.cnt as t>
			            <#if cnt.page==t>
                          <li><a class="active" href="/admin/file/${t}">${t}</a></li>
                        <#else>
                        	 <li><a href="/admin/file/${t}">${t}</a></li>
                        </#if>
                        </#list>
                          <#if cnt.page==cnt.cnt>
                           <li style="display:none"><a href="#">&#8250;</a></li>
